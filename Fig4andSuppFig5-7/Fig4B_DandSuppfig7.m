...
plot([timescale2(end),timescale2(end)],[0,maxy(2)],'k--') %469
hold off
xlabel('days')
ylabel('tumor burden')
maxad_486Let=469/284;
%% 468 NabPac
...
plot([timescale2(end),timescale2(end)],[0,maxy(2)],'k--') %179
plot([timescale3(end),timescale3(end)],[0,maxy(2)],'k--') %164
hold off
ylim([0,450])
xlabel('days')
ylabel('tumor burden')
maxad_486NabPac=179/164;
%% 288 letrozole
...
plot([ind2(end),ind2(end)],[0,maxy(2)],'k--') %4254
hold off
xlabel('days')
ylabel('tumor burden')
maxad_288Let=4254/3750;
...
plot([timescale2(end),timescale2(end)],[0,maxy(2)],'k--') %333
hold off
xlabel('days')
ylabel('tumor burden')
maxad_288Everol=333/245;
%% 15 Gemcitabine
...
plot([timescale2(end),timescale2(end)],[0,maxy(2)],'k--') %231
...
plot([timescale2(end),timescale2(end)],[0,maxy(2)],'k--') %152
plot([timescale3(end),timescale3(end)],[0,maxy(2)],'k--') %134
hold off
xlabel('days')
ylabel('tumor burden')
maxad_422Erib=152/134;
%% 422 paclitaxel
...
plot([timescale2(end),timescale2(end)],[0,maxy(2)],'k--') %151
plot([timescale3(end),timescale3(end)],[0,maxy(2)],'k--') %139.5
hold off
xlabel('days')
ylabel('tumor burden')
maxad_422pac=151/139.5;
%% 422 both
n0=[128.072230435481
85.2081632653061
59.9496062992125
...
plot([timeplot_alternating(end)*10,timeplot_alternating(end)*10],[0,maxy(2)],'k--') %321
plot([timeplot_combobreak(end)*10,timeplot_combobreak(end)*10],[0,maxy(2)],'k--') %315
hold off
xlabel('days')
ylabel('tumor burden')
%% all stats
