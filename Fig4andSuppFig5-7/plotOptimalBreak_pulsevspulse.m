function [breakadvantage,breakadvantage_base,singledose_trelapse,singledosen,time,dataplot_in,dataplot,trelapse] = plotOptimalBreak_pulsevspulse(M,Moff,n0,x_in,x,timeon_in,timeoff_in,timeon,token)
